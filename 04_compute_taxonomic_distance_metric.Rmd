...
Convert matrix to dataframe and left join to SwissProt AMPs dataset (by organism)
```{r}
...
**Figure 4.1:** Histogram of pairwise distance between each faceted organism and 756 other organisms present in the AMP dataset

<i>

**Method notes:**

Take column belonging to each organism (will have all all distances between that organism and all other organisms)
