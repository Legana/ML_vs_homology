...
Read in previously calculated AUPRC values (see 03_blast_and_prediction.Rmd) for the 13 organisms whose AMP count refer to AMPs in their respective proteomes found via the UniProt "Antimicrobial" keyword, and for the 9 organisms, whose AMP count refer to AMPs in their respective proteomes that overlap with the AMPs in the AMP database. 
...
**Table 7.1:** The inverse distance and AMP count for each organism and the AUPRC for the classification and BLAST methods for 13 organisms

```{r}
knitr::kable(auprc_and_distance_metric_wAMPcount_13)
```

**Table 7.2:** The inverse distance and AMP count for each organism and the AUPRC for the classification and BLAST methods for 9 organisms
...
pics13 <- c("http://phylopic.org/assets/images/submissions/92989e35-4e68-4a2d-b3a2-191ba9da671a.512.png",
          "http://phylopic.org/assets/images/submissions/acf1cbec-f6ef-4a82-8ab5-be2f963b93f5.512.png",
          "http://phylopic.org/assets/images/submissions/938008ab-0501-4c4d-88c5-fee17189ead3.512.png",
          "http://phylopic.org/assets/images/submissions/d71fcd12-90f6-40c4-b918-0dac0ba3e809.512.png",
          "http://phylopic.org/assets/images/submissions/b406c409-2735-4a3d-a7aa-8afe0b6e72dc.512.png",
          "http://phylopic.org/assets/images/submissions/2de1c95c-7e1f-429b-9c08-17f0a27d176f.512.png",
          "http://phylopic.org/assets/images/submissions/1df5b970-3302-4e5b-8df1-a3d9fb5744d3.512.png",
          "http://phylopic.org/assets/images/submissions/31aba24a-a797-42bb-9601-5227d0dc8f75.512.png",
          "http://phylopic.org/assets/images/submissions/afbc3136-8e5d-4417-a8b1-b7e50c09d56b.512.png",
          "http://phylopic.org/assets/images/submissions/6b9f52e9-3f9d-49b8-865b-9f2718f91ee6.512.png",
          "http://phylopic.org/assets/images/submissions/7fb6a9de-0024-4e45-bb8d-1cc32fb2470f.512.png",
          "http://phylopic.org/assets/images/submissions/4042ad12-98d4-4761-becc-9684dc071f43.512.png",
          "http://phylopic.org/assets/images/submissions/a905f3af-c8f9-470b-9496-7efb1e55e651.512.png")
          
     
     

pics9 <- c("http://phylopic.org/assets/images/submissions/92989e35-4e68-4a2d-b3a2-191ba9da671a.512.png",
          "http://phylopic.org/assets/images/submissions/acf1cbec-f6ef-4a82-8ab5-be2f963b93f5.512.png",
          "http://phylopic.org/assets/images/submissions/938008ab-0501-4c4d-88c5-fee17189ead3.512.png",
          "http://phylopic.org/assets/images/submissions/d71fcd12-90f6-40c4-b918-0dac0ba3e809.512.png",
          "http://phylopic.org/assets/images/submissions/b406c409-2735-4a3d-a7aa-8afe0b6e72dc.512.png",
...
aspect ratio solution from https://themockup.blog/posts/2020-10-11-embedding-images-in-ggplot/ 
...
**Figure 7.3** The performance of BLAST and classification models measured in Area under the Precision-Recall curve (AUPRC) in finding AMPs in the proteomes of **A)** 12 organisms where AMPs were labelled as AMPs exclusively by using the "Antimicrobial" keyword from UniProt and **B** nine organisms where AMPs were labelled as AMPs if annotated with the UniProt "Antimicrobial" keyword **and** if these AMPs overlapped with the AMP database generated from SwissProt and the APD, DRAMP or dbAMP databases.
