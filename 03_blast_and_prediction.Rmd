...
First made a function to calculate the AUPRC from a dataset, for each method, and then made a function to loop this function to calculate the AUPRC for each organism in the dataset. 
...
```{r, echo=FALSE}
saveRDS(methods_auprc, "cache/methods_auprc.rds")
```


```{r, echo = FALSE}
ggplot(methods_auprc, aes(x = Method, y = AUPRC, fill = Method)) +
  geom_col(width = 0.7) +
...
**Figure 2.1:** The area under the precision recall curve for each method and organism
