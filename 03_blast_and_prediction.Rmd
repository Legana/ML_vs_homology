...
* how to turn this into a loop so I can run the function on proteome_predictions separating by each method + organism? *
```{r}
...
auprc_mouse <- calculate_auprc_probAMP(mouse_proteome_pred, "Classification") %>% add_column(Organism = "Mouse")
auprc_cow <- calculate_auprc_probAMP(cow_proteome_pred, "Classification") %>% add_column(Organism = "Cow")
auprc_human <- calculate_auprc_probAMP(human_proteome_pred, "Classification") %>% add_column(Organism = "Human")
auprc_rat <- calculate_auprc_probAMP(rat_proteome_pred, "Classification") %>% add_column(Organism = "Rat")
auprc_chimp <- calculate_auprc_probAMP(chimp_proteome_pred, "Classification") %>% add_column(Organism = "Chimpanzee")
auprc_pig <- calculate_auprc_probAMP(pig_proteome_pred, "Classification") %>% add_column(Organism = "Pig")
auprc_dog <- calculate_auprc_probAMP(dog_proteome_pred, "Classification") %>% add_column(Organism = "Dog")
auprc_bat <- calculate_auprc_probAMP(bat_proteome_pred, "Classification") %>% add_column(Organism = "Bat")

auprc_mouse2 <- calculate_auprc_bitscore(mouse_proteome_blast, "BLAST2") %>% add_column(Organism = "Mouse")
auprc_cow2 <- calculate_auprc_bitscore(cow_proteome_blast, "BLAST2") %>% add_column(Organism = "Cow")
auprc_human2 <- calculate_auprc_bitscore(human_proteome_blast, "BLAST2") %>% add_column(Organism = "Human")
auprc_rat2 <- calculate_auprc_bitscore(rat_proteome_blast, "BLAST2") %>% add_column(Organism = "Rat")
auprc_chimp2 <- calculate_auprc_bitscore(chimp_proteome_blast, "BLAST2") %>% add_column(Organism = "Chimpanzee")
auprc_pig2 <- calculate_auprc_bitscore(pig_proteome_blast, "BLAST2") %>% add_column(Organism = "Pig")
auprc_dog2<- calculate_auprc_bitscore(dog_proteome_blast, "BLAST2") %>% add_column(Organism = "Dog")
auprc_bat2 <- calculate_auprc_bitscore(bat_proteome_blast, "BLAST2") %>% add_column(Organism = "Bat")

auprc_mouse1 <- calculate_auprc_bitscore(mouse_amps_blast, "BLAST1") %>% add_column(Organism = "Mouse")
auprc_cow1 <- calculate_auprc_bitscore(cow_amps_blast, "BLAST1") %>% add_column(Organism = "Cow")
auprc_human1 <- calculate_auprc_bitscore(human_amps_blast, "BLAST1") %>% add_column(Organism = "Human")
auprc_rat1 <- calculate_auprc_bitscore(rat_amps_blast, "BLAST1") %>% add_column(Organism = "Rat")
auprc_chimp1 <- calculate_auprc_bitscore(chimp_amps_blast, "BLAST1") %>% add_column(Organism = "Chimpanzee")
auprc_pig1 <- calculate_auprc_bitscore(pig_amps_blast, "BLAST1") %>% add_column(Organism = "Pig")
auprc_dog1<- calculate_auprc_bitscore(dog_amps_blast, "BLAST1") %>% add_column(Organism = "Dog")
auprc_bat1 <- calculate_auprc_bitscore(bat_amps_blast, "BLAST1") %>% add_column(Organism = "Bat")

auprc_combined <- rbind(auprc_mouse, auprc_mouse1, auprc_mouse2, auprc_cow, auprc_cow1, auprc_cow2, auprc_human, auprc_human1, auprc_human2, auprc_rat, auprc_rat1, auprc_rat2, auprc_chimp, auprc_chimp1, auprc_chimp2, auprc_pig, auprc_pig1, auprc_pig2, auprc_dog, auprc_dog1, auprc_dog2, auprc_bat, auprc_bat1, auprc_bat2 ) %>%  mutate(Organism = factor(Organism, levels = c("Human", "Chimpanzee","Mouse" ,"Rat" , "Cow", "Pig", "Dog", "Bat"))) %>% mutate(Method = factor(Method, levels = c("Classification", "BLAST1", "BLAST2")))

saveRDS(auprc_combined, "cache/auprc_combined.rds")
```


```{r, echo = FALSE}
auprc_combined <- readRDS("cache/auprc_combined.rds")

ggplot(auprc_combined, aes(x = Method, y = AUPRC, fill = Method)) +
  geom_col(width = 0.7) +
  facet_wrap(~Organism, ncol = 2) +
  theme_black() +
  labs(fill = "")

ggsave("figures/auprcs.png", width = 7, height = 7)
```
