...
rabbit_proteome_metadata <- mouse_proteome_metadata %>% mutate(Label_strict = ifelse(Entry %in% uniprot_and_amp_dbs_amps$Entry, "Pos", "Neg"))
platypus_proteome_metadata <- mouse_proteome_metadata %>% mutate(Label_strict = ifelse(Entry %in% uniprot_and_amp_dbs_amps$Entry, "Pos", "Neg"))
