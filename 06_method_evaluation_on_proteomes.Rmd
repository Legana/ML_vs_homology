...
AMPs not accounted for was calculated by subtracting the AMPs_overlap_in_AMP_db from AMPs_in_AMP_db and then substracting this number from the Number of AMPs in proteome not annotated as AMP
